  ...
  return (
    <main className="pbPageLegal">
      <div className="pbContainer pbLegalWrapper">
        ...
        <p>
          When a visitor clicks a product link, category link, or call-to-action,
          they may be redirected to a third-party platform such as Mary Kay®,
          where product details, transactions, payment processing, shipping,
          returns, and customer service are handled exclusively.
        </p>
        ...
        <ul>
          ...
          <li>Referral or traffic source</li>
          <li>Clicks on product cards, category links, and referral buttons</li>
        </ul>
        ...
        <p>
          ...
          improving platform performance, analyzing engagement, responding to
          inquiries, and maintaining security.
        </p>

        <ul>
          <li>Improve usability, speed, and design</li>
          <li>Understand user interaction with products and categories</li>
        ...
        <ul>
          ...
          <li>Third-party referral tracking</li>
        </ul>
        ...
        <p>
          avecosmetico.com  by AVE® Cosmetics Company is not responsible for third-party systems, including
          checkout, payments, shipping, returns, or customer support.
        </p>
        ...
        <p>
          ...
          the platform. However, no internet transmission can be guaranteed to
        ...
        <p>
          ...
          information, including access, correction, or deletion requests.
        </p>
        ...
        <p>
          ...
          through the platform’s contact page.
        </p>
